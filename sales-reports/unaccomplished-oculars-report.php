        ...
        <div class="ui basic padded segment">
          <div class="ui relaxed grid">
            ...
            <div class="thirteen wide centered column">
              <div class="ui basic padded segment">
                <h3 class="ui centered header">Unaccomplished Oculars Report</h3>
                  ...
                  <div class="field">
                    <table id="oculars" class="ui celled table">
                      ...
                      <tbody>
						...
						$sql = "SELECT ov.occular_id, ov.date, c.name FROM occular_visits  ov JOIN customer c on c.customerid = ov.customerid JOIN pending_order po ON po.pending_order_id = ov.occular_id WHERE ov.occular_id IN (SELECT po.pending_order_id FROM pending_order)";
