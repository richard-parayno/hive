        ...
        <div class="ui basic padded segment">
          <div class="ui relaxed grid">
            ...
            <div class="eight wide centered column">
              <div class="ui basic padded segment">
                <h3 class="ui centered header">General Services Report</h3>
                  ...
                  <div class="field">
                    <table class="ui celled table">
                      ...
                      <tbody>
						...
						$sql = "SELECT gs.generalserviceid, gs.joborder_jonumber, jo.startdate, c.name FROM general_services gs join job_order jo on jo.jonumber = gs.joborder_jonumber join customer c"; 
						...
						while($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)){
							...
							echo "<tr>
							<td width=\"10%\"><a href=\"clientreport.php?pk={$row['generalserviceid']}\"><div align=\"center\">{$row['generalserviceid']}
							</div></a></td> 
							<td width=\"10%\"><div align=\"center\">{$row['jonumber']}</a>
							</div></a></td>
							<td width=\"10%\"><div align=\"center\">{$row['name']}</a>
							</div></a></td>
							<td width=\"5%\"><div align=\"center\">{$row['startdate']}</a>
							</div></td
							</tr>";
							}
						?>
