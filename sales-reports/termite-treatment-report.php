            ...
            <div class="thirteen wide centered column">
              <div class="ui basic padded segment">
				...
				<form class="ui form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                  ...
                  <div class="field">
                    <table id="termite" class="ui celled table">
                      <thead>
                        <tr>
                          <th>ID Number</th>
                          <th>Customer Name</th>
                      ...
                      <tbody>
						...
						$sql = "SELECT tt.ttspidno, tt.joborderno, tt.date, c.name FROM termitetreatment_serviceperformance tt join job_order jo on jo.jonumber = tt.joborderno join customer c on c.customerid = jo.customerid ";
						...
						while($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)){
							...
							echo "<tr>
							<td width=\"5%\"><div align=\"center\">{$row['ttspidno']}
							</div></a></td>
