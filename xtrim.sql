...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2017 at 09:03 PM
...
(1, 'Sean', '9216011', 'gallego st', 'Active');
...
CREATE TABLE `customer_service` (
  `customer_rate_id` int(11) NOT NULL,
  `punctuality` varchar(5) DEFAULT NULL,
  `employee_id` int(11) DEFAULT NULL,
  `job_order` int(11) DEFAULT NULL,
  `termitetreatment` int(11) DEFAULT NULL,
  `work_speed` int(11) DEFAULT NULL,
...
CREATE TABLE `employee_performance` (
  ...
  `employee_ID` int(11) DEFAULT NULL,
  `communication_grade` int(11) DEFAULT NULL,
  `initiative_grade` int(11) DEFAULT NULL,
  `groupwork_grade` int(11) DEFAULT NULL,
  `client_relation_grade` int(11) DEFAULT NULL,
  `work_grade` int(11) DEFAULT NULL,
...
INSERT INTO `occular_visits` (`Occular_ID`, `CustomerID`, `Area_Infection`, `Date`, `Status`, `Area_Size`, `LF_At_Site`, `Remarks`, `Findings`, `SupervisedBy`, `Call_Received_By`, `pending_order`, `Recommendation`) VALUES
(1, 1, NULL, '2017-04-05 00:00:00', 'Active', NULL, 'Richard Lance Parayno', NULL, NULL, 5, 1, 1, NULL);
...
INSERT INTO `pending_order` (`pending_order_Id`, `Job_order_type`, `Address`, `customer`, `employee_recieved`, `date`, `customerType`, `Area_type`, `status`, `remarks`) VALUES
(1, 'Termite Treatment', 'Gallego St', 1, 1, '2017-04-05', 1, 'Resident', 'Active', '');
...
ALTER TABLE `customer_service`
  ADD PRIMARY KEY (`customer_rate_id`),
  ADD KEY `employee_idx` (`employee_id`),
  ADD KEY `job_order_idx` (`job_order`),
  ADD KEY `termite_fk_idx` (`termitetreatment`);
...
--
ALTER TABLE `customer_service`
  MODIFY `customer_rate_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `occular_visits`
  MODIFY `Occular_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pending_order`
--
ALTER TABLE `pending_order`
  MODIFY `pending_order_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `customer_service`
  ADD CONSTRAINT `fk_employee` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`EmployeeNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `job_order` FOREIGN KEY (`job_order`) REFERENCES `job_order` (`JONumber`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `termite_fk` FOREIGN KEY (`termitetreatment`) REFERENCES `termitetreatment_serviceperformance` (`TTSPIDNO`) ON DELETE NO ACTION ON UPDATE NO ACTION;
