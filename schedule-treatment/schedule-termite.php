    ...
    <div class="sixteen wide column">
      ...
      <div class="ui basic padded segment">
       ...
       require_once('../mysql_connect.php');
				 $toSchedule = $_POST['termite-oculars'] ;
			//	$toSchedule =4;
       $query="Select * from occular_visits where occular_id = '{$toSchedule}' ";
        ...
        $stype= $getIt['Area_type'];
           ...
           //$dt = new DateTime("2015-11-01 00:00:00"
				$dateTimeclass =  new DateTime ($_POST['initial-treat-termite']);
          $endDate= new DateTime ($_POST['initial-treat-termite']);
      //  echo "WTF IS RON" .$stype;
			...
			echo "<br>";
  			?>
                  ...
                  <form class="ui form" method="post" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]);?>">
                    <?php 
              		 $toSchedule = new DateTime ($_POST['initial-treat-termite']);
              		  $endDate= new DateTime($_POST['initial-treat-termite']);
