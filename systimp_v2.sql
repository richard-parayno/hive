...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2017 at 10:40 AM
...
(1, 'Premise', 200, 100, 'This chemical is used for...', 'Available', 'Hanes Phil. Inc.,', NULL),
...
INSERT INTO `occular_visits` (`Occular_ID`, `CustomerID`, `JobSite_Adress`, `Area_Type`, `Area_Infection`, `Date`, `Status`, `Area_Size`, `Time_Agreed`, `LF_At_Site`, `Remarks`, `Findings_and_Recommendations`, `SupervisedBy`, `Call_Received_By`, `pending_order`) VALUES
(1, 1, 'Rizal', 'Residence ', 'Heavy', '2016-12-02 00:00:00', 'Active', 500, '14:00:00', 'Francis ', NULL, 'omg', 2, 1, NULL);
...
ALTER TABLE `occular_visits`
  ...
  ADD KEY `fk_pending_idx` (`pending_order`);
...
--
ALTER TABLE `job_order`
  MODIFY `JONumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `occular_visits`
  ...
  ADD CONSTRAINT `fk_pending` FOREIGN KEY (`pending_order`) REFERENCES `pending_order` (`pending_order_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
