      ...
      <div class="ui relaxed grid">
        ...
        <div class="sixteen wide centered column">
          <div class="ui  padded segment">
            <h3 class="ui centered header">Employee Performance Report</h3>
            <div class="ui divider"></div>
            <br>
            <form class="ui form">
              <div class="field">
                <label>Month</label>
                <select name="month" id="month" class="ui search dropdown" onchange="performanceTable(this.value)">
